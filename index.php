...
<html>
	...
	<body style="min-width: 980px;">
		...
		<div class="home-welcome">
			<div class="home-welcome-text" style="background-image: url(image/bg.jpg); height: 380px; ">
				<div style="padding-top: 180px;">
					<div style=" background-color: #dadbe6;">
						<h1 style="margin: 0px;">Welcome To FreshMart</h1>
					</div>
				</div>
			</div>
		</div>
				...
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/NoodlesCanned.php">
							<img src="./image/product/noodles/header.jpg" class="home-prodlist-imgi">
							</a>
						</div>
					</li>
				</ul>
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/Snacks.php">
							<img src="./image/product/snack/chips.jpg" class="home-prodlist-imgi">
							</a>
						</div>
					</li>
				</ul>
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/Sweets.php">
							<img src="./image/product/sweet/sweets.jpg" class="home-prodlist-imgi"></a>
						</div>
					</li>
				</ul>
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/Hygene.php">
							<img src="./image/product/hygiene/soap.jpg" class="home-prodlist-imgi"></a>
						</div>
					</li>
				</ul>
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/Shampoo.php">
							<img src="./image/product/shampoo/shampoo.webp" class="home-prodlist-imgi"></a>
						</div>
					</li>
				</ul>
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/Soap&Detergent.php">
							<img src="./image/product/soap/detergent.jpg" class="home-prodlist-imgi"></a>
						</div>
					</li>
				</ul>
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/Drinks.php">
							<img src="./image/product/drink/drinkz.jpg" class="home-prodlist-imgi"></a>
						</div>
					</li>
				</ul>
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/Seasonings.php">
							<img src="./image/product/seasoning/condiments1.jpg" class="home-prodlist-imgi"></a>
						</div>
					</li>
				</ul>
			</div>			
